...
"""
openedx-userapi documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-userapi',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/makerspace-darmstadt/openedx-userapi",
...
#
# html_title = 'openedx-userapi v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'API for managing users',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_userapi'),
                os.path.join(root_path, 'openedx_userapi/migrations')])

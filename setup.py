#!/usr/bin/env python
"""
Package metadata for openedx_userapi.
"""
import os
import re
import sys
...
VERSION = get_version("openedx_userapi", "__init__.py")
...
setup(
    name="openedx-userapi",
    version=VERSION,
    description="""API for managing users""",
    long_description=README + "\n\n" + CHANGELOG,
    author="Daniel Herrmann",
    author_email="daniel.herrmann@makerspace-darmstadt.de",
    url="https://github.com/makerspace-darmstadt/openedx-userapi",
    packages=find_packages(
        include=["openedx_userapi", "openedx_userapi.*"],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "openedx_userapi = openedx_userapi.apps:OpenedxUserapiConfig"
        ],
    },
)
